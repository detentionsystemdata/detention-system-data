...
# call that touches GitHub state on this repo (releases, tags via API, repo
# settings) instead of calling `gh` directly.
#
# Usage: scripts/gh-as-bot.sh release create 2026.07.25 --title "..."
set -euo pipefail
